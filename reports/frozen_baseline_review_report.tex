...
This report freezes the pre-improvement baseline before any future algorithm-strengthening work. The current benchmark inventory contains 14 packaged experiment runs: 3 exact, 6 epsilon-certified, 5 smoke-only, and 0 failed. The validation chain from reference disaster primal through the production Benders engine is already built and individually checked, but the harder exact-mode convergence cases remain non-certified.
...
\begin{itemize}
\item integrated\_mainline\_certified\_small: validation=epsilon\_certified, stop=certified\_epsilon, construction=4,421,143.360, weighted normal=20,588,064.250, disaster master=167.617432
\item normal\_only\_certified\_small: validation=exact, stop=direct\_optimal, construction=4,421,143.360, weighted normal=22,875,626.944, disaster master=0.000000
\item deterministic\_mean\_value\_certified\_small: validation=epsilon\_certified, stop=certified\_epsilon, construction=4,421,143.360, weighted normal=20,588,064.250, disaster master=167.617432
\end{itemize}
...
\begin{itemize}
\item - `exact`: `normal\_only\_certified\_small`, `normal\_only\_paper\_like`, `normal\_only\_runtime12`
\item - `epsilon\_certified`: `integrated\_mainline\_certified\_small`, `deterministic\_mean\_value\_certified\_small`, `integrated\_mainline\_paper\_like`, `deterministic\_mean\_value\_paper\_like`, `ev\_penetration\_1\_5x\_paper\_like`, `ev\_penetration\_2\_0x\_paper\_like`
...
\hline
certified\_small\_integrated & integrated\_mainline\_certified\_small & True & True & True & baseline source was regenerated because current Round 12 outputs no longer include certified-small artifacts \\
runtime12\_integrated & integrated\_mainline\_runtime12 & True & True & True & rerun matched baseline within configured tolerances \\
hard\_exact\_mode & integrated\_paper\_like\_exact\_i20\_k2\_a1b1 & True & True & True & rerun matched baseline within configured tolerances \\
\hline
\end{tabular}
\end{center}
